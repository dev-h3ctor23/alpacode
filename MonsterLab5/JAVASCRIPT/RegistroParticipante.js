...
function validarCamposCompletos() {
  const camposObligatorios = document.querySelectorAll(".form-step-active input[required], .form-step-active textarea[required]");
...
function registrarParticipante(event) {
  ...
  let nombrePadreMadre = document.getElementById("Nombre").value;
  let apellidosPadreMadre = document.getElementById("Apellidos").value;
  let emailPadreMadre = document.getElementById("email").value;
  let telefonoPadreMadre = document.getElementById("Telefono").value;
  let formaPago = document.querySelector('input[name="formaPago"]:checked')
    ? document.querySelector('input[name="formaPago"]:checked').id
    : "";

  let nombreResponsable = document.getElementById("NombreResp").value;
  let apellidosResponsable = document.getElementById("ApellidosResp").value;
  let emailResponsable = document.getElementById("emailResp").value;
  let telefonoResponsable = document.getElementById("TelefonoResp").value;
  ...
  // Mostrar el registro en consola
...
document.getElementById("registrationForm").addEventListener("submit", function(event) {
  ...
  // Si hay algún campo vacío, mostrar el alert
  if (camposVacios) {
